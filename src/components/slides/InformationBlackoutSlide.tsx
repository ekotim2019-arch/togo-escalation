  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-paper">What You Don&rsquo;t Know <span className="text-threat-critical">CAN</span> Hurt You</h2>
      </motion.div>

      <div className="flex-1 flex flex-col gap-6 px-16 pb-16 relative z-10">
        {/* HAAC quote */}
        <motion.div
          className="bg-ink border border-threat-critical/40 rounded-xl p-6 relative"
          initial={{ opacity: 0, scale: 0.97 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.3, duration: 0.5 }}
        >
          <div className="text-threat-critical text-xs font-bold tracking-widest mb-3 uppercase">Official Media Suppression — HAAC Directive</div>
          <blockquote className="text-xl text-paper font-light italic leading-relaxed border-l-4 border-threat-critical pl-6">
        ...
        <div className="flex-1 flex gap-6">
          <div className="flex-1">
            ...
            >
              <div className="text-ash text-xs font-bold tracking-widest uppercase mb-3">Critical Intelligence Gaps</div>
            </motion.div>
            <div className="space-y-2">
              {gaps.map((gap, i) => (
                <motion.div
                  key={i}
                  className="flex items-start gap-3 bg-threat-critical/5 border border-threat-critical/15 rounded-lg px-4 py-3"
                ...
                >
                  ...
                  <div className="ml-auto shrink-0">
                    <span className="text-threat-critical text-xs font-mono font-bold">BLIND</span>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <motion.div
            ...
            transition={{ delay: 0.5 }}
          >
            <div className="bg-ink border border-ash/20 rounded-xl p-5 flex-1">
              <div className="text-ash text-xs font-bold tracking-widest uppercase mb-4">Consequence</div>
              <div className="space-y-4 text-sm text-paper/70 leading-relaxed">
                <p>When an attack occurs, Togolese authorities learn about it from social media — <span className="text-threat-critical font-semibold">not from intelligence channels.</span></p>
                <p>The first warning is the attack itself.</p>
                <p className="text-paper font-semibold">By then, it&rsquo;s too late to respond, only to react.</p>
              </div>
            </div>

            <div className="bg-amber/10 border border-amber/30 rounded-xl p-5">
              <div className="text-amber text-xs font-bold tracking-widest uppercase mb-2">Kairos Arc Fills This Gap</div>
