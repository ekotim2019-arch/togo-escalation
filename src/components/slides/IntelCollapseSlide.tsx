  ...
  return (
    <SlideWrapper>
      <div className="relative z-10 w-full max-w-4xl">
        ...
        >
          <div className="flex-1 bg-red/[0.08] border border-red/20 rounded-md p-10text-center">
          ...
          <div className="flex-1 bg-white/[0.03] border border-white/[0.08] rounded-md p-10text-center">
