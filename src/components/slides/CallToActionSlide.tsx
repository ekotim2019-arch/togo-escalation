      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        <div className="flex flex-col gap-8 mb-16">
          ...
          >
            ...
            <div className="flex-1 bg-white/[0.03] border border-white/[0.08] rounded-md p-20">
          ...
          >
            ...
            <div className="flex-1 bg-amber/[0.06] border border-amber/20 border-l-[3px] border-l-amber rounded-r-md p-20">
          ...
          >
            ...
            <div className="flex-1 bg-red/[0.06] border border-red/20 border-l-[3px] border-l-red rounded-r-md p-20">
        ...
        <motion.div
          ...
          className="text-center pt-32 border-t border-amber/15"
        >
